...
pub trait Device<I: Interface> {
    ...
    async fn estimated_current_draw(&mut self) -> ElectricCurrent { 0f64 } // Amps
}
...
pub trait I2cSensor16Bit<N: Instance + 'static>: Sensor + I2cDevice<N> {
    async fn read_single_be(&mut self, address: &[u8], conversion_factor: f64) -> Result<f64, DeviceError> {
